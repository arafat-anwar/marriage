...
<html lang="en">
  <head>
    <title>{{ systemInformation()->name }} :: Pay Registration Fee</title>
  ...
  <body>
    <div id="smart-button-container" style="padding-top: 150px;">
      <div style="text-align: center;">
        ...
        <a href="{{ url('registration-fee-cancel') }}" style="color: red;font-weight: bold;text-decoration: none">Cancel Registration</a>
      </div>
    </div>
      ...
      paypal.Buttons({
        ...
        createOrder: function(data, actions) {
          return actions.order.create({
            purchase_units: [{"description":"Registration fee","amount":{"currency_code":"USD","value":30}}]
          });
        },
