                                ...
                                <div class="overflow-hidden shadow-none border-right">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-5 text-dark text-center">
                                            <span class="sush-title-lg fw-600 lh-1 mb-0">Free</span>
                                            <span class="text-secondary d-block">validity 90 Days</span>
                                        </div>
                                        <div class="text-center">
                                            @if(auth()->check() && in_array(auth()->user()->role_id, [3]))
                                                <a href="{{ url('profile') }}" class="btn btn-light" tabindex="0">Purchase This Package</a>
                                            @else
                                                <a href="{{ url('register') }}" class="btn btn-light" tabindex="0">Purchase This Package</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
