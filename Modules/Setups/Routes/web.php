...
Route::prefix('setups')->group(function() {
    ...
    Route::get('admins/{id}/logs', 'AdminController@logs');
    Route::get('admins/{id}/courses', 'AdminController@courses');
    Route::get('admins/{division_id}/get-districts', 'AdminController@getDistricts');
    ...
    Route::resource('database-backups', 'DBBackupController');
});
