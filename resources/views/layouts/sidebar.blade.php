...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('dashboard')}}" class="brand-link">
      <img src="{{ url('public/system-images/logos/'.systemInformation()->logo) }}" class="brand-image" style="opacity: .8">
    </a>
    ...
    <div class="sidebar half-a-second">
        <nav class="mt-2">
		  ...
		  @foreach ($modules as $key => $module)
		    <li class="nav-item has-treeview {{isset($links[0]) && $module->route == $links[0] ? 'menu-open' : ''}}">
